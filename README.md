...
| `get_connections` | List the authenticated user's 1st-degree connections, sorted by recently added, with profile links and headlines | [#453](https://github.com/stickerdaniel/linkedin-mcp-server/issues/453) |
